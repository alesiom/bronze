...
export const colors = {
  ...
  sportColors: {
    ...
    STK: '#6B4423',    // Skeleton - Bronze/rust (daring)
    SKN: '#4A5568',    // Short Track Speed Skating - Cool gray (ice/speed)
    SJP: '#3D5A80',    // Ski Jumping - Sky blue (flight)
    SKM: '#6B8E23',    // Ski Mountaineering - Olive drab (mountain/alpine NEW 2026)
    SMT: '#2D5A5A',    // Snowboard - Teal (youth/style)
    SBD: '#2D5A5A',    // Snowboard alt - Teal
...
export const darkColors = {
  ...
  sportColors: {
    ...
    STK: '#CDA574',    // Skeleton - Light bronze (7.1:1)
    SKN: '#B8C4D0',    // Short Track - Light steel (8.4:1)
    SJP: '#8FC5E8',    // Ski Jumping - Light azure (8.7:1)
    SKM: '#B8D468',    // Ski Mountaineering - Light lime (8.9:1)
    SMT: '#7DD4C4',    // Snowboard - Light teal (9.2:1)
    SBD: '#7DD4C4',    // Snowboard alt - Light teal (9.2:1)
